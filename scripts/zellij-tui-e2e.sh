...
add_case normal-080x20 80 20 2026-07-06 normal-day \
  'worklog-timeblock|2026-07-06|Build|Standup|dev|0.75h|meeting|0.25h|other|0.25h' \
  'Warnings|Exception|Stacktrace|Error'
add_case uncategorized-060x20 60 20 2026-07-06 uncategorized-warning \
  'worklog-timeblock|2026-07-06|Unknown|Uncategorized: Unknown|dev|0.75h|other|0.17h|Warnings' \
  'Exception|Stacktrace|Error'
add_case excluded-060x20 60 20 2026-07-06 excluded-log-not-totaled \
  'worklog-timeblock|2026-07-06|Lunch|excluded|Build|dev|0.75h|other|0.08h' \
  'Warnings|meeting|Exception|Stacktrace|Error'
add_case rounding-080x20 80 20 2026-07-06 rounding-boundaries \
  'worklog-timeblock|2026-07-06|Short14|Exact15|meeting|0.25h|other|0.25h' \
  'dev                 |Exception|Stacktrace|Error'
add_case long-japanese-040x20 40 20 2026-07-06 narrow-long-japanese \
  'worklog-timeblock|2026-07-06|非常に長い|very-long-category-id|0.75h|Warnings|未分類候補' \
  'Exception|Stacktrace|Error'
add_case narrow-032x10 32 10 2026-07-06 very-narrow-small-data \
  'worklog-timeblock|2026-07-06|09:00-09:15 confirmed Build|dev 0.25h' \
  'Warnings|Exception|Stacktrace|Error|confirmedBuild'
...
add_case specials-120x20 120 20 2026-07-06 special-characters \
  'worklog-timeblock|2026-07-06|Escape <tag> & "quote"|dev|0.25h' \
  'Exception|Stacktrace|Error'
...
create_db() {
  ...
  sqlite3 "$db" <<SQL
INSERT INTO categories (id, name, kind) VALUES ('dev', 'Development', 'normal');
INSERT INTO categories (id, name, kind) VALUES ('meeting', 'Meetings', 'normal');
INSERT INTO categories (id, name, kind) VALUES ('support', 'Support', 'normal');
INSERT INTO categories (id, name, kind) VALUES ('research', 'Research', 'normal');
INSERT INTO categories (id, name, kind) VALUES ('very-long-category-id', 'Very Long Category Name', 'normal');
INSERT INTO categories (id, name, kind) VALUES ('other', 'Other', 'other');
SQL

  case "$case_id" in
    normal-080x20)
      sqlite3 "$db" <<SQL
INSERT INTO work_logs (date,title,start_minute,end_minute,state,category_id) VALUES ('2026-07-06','Build',540,590,'confirmed','dev');
INSERT INTO work_logs (date,title,start_minute,end_minute,state,category_id) VALUES ('2026-07-06','Standup',600,615,'confirmed','meeting');
SQL
      ;;
    uncategorized-060x20)
      sqlite3 "$db" <<SQL
INSERT INTO work_logs (date,title,start_minute,end_minute,state,category_id) VALUES ('2026-07-06','Build',540,585,'confirmed','dev');
...
SQL
    ...
    rounding-080x20)
      sqlite3 "$db" <<SQL
INSERT INTO work_logs (date,title,start_minute,end_minute,state,category_id) VALUES ('2026-07-06','Short14',540,554,'confirmed','dev');
INSERT INTO work_logs (date,title,start_minute,end_minute,state,category_id) VALUES ('2026-07-06','Exact15',555,570,'confirmed','meeting');
SQL
      ;;
    long-japanese-040x20)
      sqlite3 "$db" <<SQL
INSERT INTO work_logs (date,title,start_minute,end_minute,state,category_id) VALUES ('2026-07-06','非常に長いタイトルの開発作業とレビュー確認',540,585,'confirmed','very-long-category-id');
...
SQL
    ...
    narrow-032x10)
      sqlite3 "$db" <<SQL
INSERT INTO work_logs (date,title,start_minute,end_minute,state,category_id) VALUES ('2026-07-06','Build',540,555,'confirmed','dev');
SQL
      ;;
    empty-080x10)
      ;;
    specials-120x20)
      sqlite3 "$db" <<SQL
INSERT INTO work_logs (date,title,start_minute,end_minute,state,category_id) VALUES ('2026-07-06','Escape <tag> & "quote"',540,555,'confirmed','dev');
SQL
      ;;
  esac
